...
const AP_Param::GroupInfo AP_MotorsHeli::var_info[] PROGMEM = {
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("THROTTLE_MIN", 23, AP_MotorsHeli, _throttle_min_pwm, AP_MOTORS_HELI_THROTTLE_MIN),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("THROTTLE_IDLE", 24, AP_MotorsHeli, _throttle_idle_pwm, AP_MOTORS_HELI_THROTTLE_IDLE),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("THROTTLE_LOW", 25, AP_MotorsHeli, _throttle_low_pwm, AP_MOTORS_HELI_THROTTLE_LOW),
    ...
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("THROTTLE_HIGH", 26, AP_MotorsHeli, _throttle_high_pwm, AP_MOTORS_HELI_THROTTLE_HIGH),
    ...
    switch (_rsc_mode){
        ...
        case AP_MOTORS_HELI_RSC_MODE_THROTTLE_CURVE:
            ...
            if (_desired_rotor_speed > 0){
                ...
                throttle_rate_damper = _rotor_out/_desired_rotor_speed;

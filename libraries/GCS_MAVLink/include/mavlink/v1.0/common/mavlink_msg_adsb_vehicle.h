...
typedef struct __mavlink_adsb_vehicle_t
{
 ...
 float lat; /*< The reported lattitude in degrees*/
 ...
 float ver_velocity; /*< The vertical velocity in meters/second*/
 ...
 uint8_t emitterType; /*< Type from ADSB_EMITTER_CATEGORY_TYPE enum*/
 uint8_t tslc; /*< Time since last communication in seconds*/
 uint8_t validFlags; /*< Flags to Indicate valid data fields*/
} mavlink_adsb_vehicle_t;

#define MAVLINK_MSG_ID_ADSB_VEHICLE_LEN 39
#define MAVLINK_MSG_ID_246_LEN 39

#define MAVLINK_MSG_ID_ADSB_VEHICLE_CRC 92
#define MAVLINK_MSG_ID_246_CRC 92
...
#define MAVLINK_MESSAGE_INFO_ADSB_VEHICLE { \
	...
	{  { "ICAO_address", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_adsb_vehicle_t, ICAO_address) }, \
         ...
         { "emitterType", NULL, MAVLINK_TYPE_UINT8_T, 0, 36, offsetof(mavlink_adsb_vehicle_t, emitterType) }, \
         { "tslc", NULL, MAVLINK_TYPE_UINT8_T, 0, 37, offsetof(mavlink_adsb_vehicle_t, tslc) }, \
         { "validFlags", NULL, MAVLINK_TYPE_UINT8_T, 0, 38, offsetof(mavlink_adsb_vehicle_t, validFlags) }, \
         } \
}
 ...
 * @param lat The reported lattitude in degrees
 ...
 * @param ver_velocity The vertical velocity in meters/second
 * @param callsign The callsign(squawk)
 * @param emitterType Type from ADSB_EMITTER_CATEGORY_TYPE enum
 * @param tslc Time since last communication in seconds
 * @param validFlags Flags to Indicate valid data fields
...
static inline uint16_t mavlink_msg_adsb_vehicle_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t ICAO_address, float lat, float lon, uint8_t altitude_type, float altitude, uint16_t heading, float hor_velocity, float ver_velocity, const char *callsign, uint8_t emitterType, uint8_t tslc, uint8_t validFlags)
{
	...
	_mav_put_uint8_t(buf, 36, emitterType);
	_mav_put_uint8_t(buf, 37, tslc);
	_mav_put_uint8_t(buf, 38, validFlags);
...
static inline void mavlink_msg_adsb_vehicle_send(mavlink_channel_t chan, uint32_t ICAO_address, float lat, float lon, uint8_t altitude_type, float altitude, uint16_t heading, float hor_velocity, float ver_velocity, const char *callsign, uint8_t emitterType, uint8_t tslc, uint8_t validFlags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ADSB_VEHICLE_LEN];
	_mav_put_uint32_t(buf, 0, ICAO_address);
 ...
 *
 * @return The reported lattitude in degrees
 */
 ...
 *
 * @return The vertical velocity in meters/second
 */
...
/**
 * @brief Get field emitterType from adsb_vehicle message
 *
 * @return Type from ADSB_EMITTER_CATEGORY_TYPE enum
 */
static inline uint8_t mavlink_msg_adsb_vehicle_get_emitterType(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field validFlags from adsb_vehicle message
 *
 * @return Flags to Indicate valid data fields
 */
static inline uint8_t mavlink_msg_adsb_vehicle_get_validFlags(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_adsb_vehicle_decode(const mavlink_message_t* msg, mavlink_adsb_vehicle_t* adsb_vehicle)
{
	...
	adsb_vehicle->emitterType = mavlink_msg_adsb_vehicle_get_emitterType(msg);
	adsb_vehicle->tslc = mavlink_msg_adsb_vehicle_get_tslc(msg);
	adsb_vehicle->validFlags = mavlink_msg_adsb_vehicle_get_validFlags(msg);
#else

...
/** @brief These flags indicate data validity of each data source. Set = data valid */
#ifndef HAVE_ENUM_ADSB_DATA_VALID_FLAGS
#define HAVE_ENUM_ADSB_DATA_VALID_FLAGS
typedef enum ADSB_DATA_VALID_FLAGS
{
	...
	ADSB_DATA_VALID_FLAGS_ENUM_END=129, /*  | */
} ADSB_DATA_VALID_FLAGS;
#endif
